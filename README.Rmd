...
Alternatively, algatr can be run using [Docker](https://docs.docker.com/get-started/). First, install Docker, then you can start algatr within a Docker container: 
```bash
