...
We can combine all three PCs into a single map by scaling each of the rasters in such a way that they each correspond to either R, G, or B using the `scaleRGB()` function.
...
# TODO[EAC]: make this into a function scaleRGB
for(layer in 1:3){
