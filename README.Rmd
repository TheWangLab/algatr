...
+=============================================================+==========================================================+================================================================================================================+=====================================================================================================+==========================+
| How do we delineate population units for management?        | Population structure                                     | TESS (Caye et al. 2016)                                                                                        | [TESS_vignette.Rmd](https://github.com/TheWangLab/algatr/blob/main/vignettes/TESS_vignette.Rmd)     | `tess_do_everything()`   |
+-------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+--------------------------+
| How is genetic variation distributed?                       | Genetic diversity                                        | Moving windows of genetic diversity; wingen (Bishop et al. 2023)                                               | [wingen_vignette.Rmd](https://github.com/TheWangLab/algatr/blob/main/vignettes/wingen_vignette.Rmd) | `wingen_do_everything()` |
+-------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+--------------------------+
| What are the drivers of population connectivity?            | Isolation by distance/isolation by environment (IBD/IBE) | Multiple matrix regression with randomization; MMRR (Wang 2013)                                                | [MMRR_vignette.Rmd](https://github.com/TheWangLab/algatr/blob/main/vignettes/MMRR_vignette.Rmd)     | `mmrr_do_everything()`   |
|                                                             |                                                          |                                                                                                                |                                                                                                     |                          |
|                                                             |                                                          | Generalized dissimilarity modeling; GDM (Ferrier et al. 2007; Freedman et al. 2010; Fitzpatrick & Keller 2015) | [GDM_vignette.Rmd](https://github.com/TheWangLab/algatr/blob/main/vignettes/GDM_vignette.Rmd)       | `gdm_do_everything()`    |
+-------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+--------------------------+
| How can we identify and protect adaptive genetic variation? | Genotype-environment associations (GEA)                  | Redundancy analysis; RDA (Capblancq & Forester 2021)                                                           | [RDA_vignette.Rmd](https://github.com/TheWangLab/algatr/blob/main/vignettes/RDA_vignette.Rmd)       | `rda_do_everything()`    |
|                                                             |                                                          |                                                                                                                |                                                                                                     |                          |
|                                                             |                                                          | Latent factor mixed models; LFMM (Caye et al. 2019)                                                            | [LFMM_vignette.Rmd](https://github.com/TheWangLab/algatr/blob/main/vignettes/LFMM_vignette.Rmd)     | `lfmm_do_everything()`   |
+-------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------+--------------------------+
