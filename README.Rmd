...
You can also view the knitted versions of this README and all of algatr's vignettes on the **package's pkgdown website [here](https://thewanglab.github.io/algatr/index.html).**
...
```{r rasters, warning = FALSE, message = FALSE, fig.width = 5, fig.height = 5}
...
```{r, RGB, fig.height = 3, fig.align='center'}
env <- scaleRGB(CA_env)
...
```{r doeverything, warning = FALSE, message = FALSE}
