...
cor_table(cor_df, nrow = 5)

# you can order by the strength of the correlation
cor_table(cor_df, order = TRUE, nrow = 5)

# you can choose to only keep the top variable for each SNP the table by the strength of the correlation
cor_table(cor_df, top = TRUE, nrow = 5)

# you can display only select environmental variables
cor_table(cor_df, env = "CA_rPCA1", nrow = 5)

# putting it all together we can display the top 5, ordered SNPS for each variable
cor_table(cor_df, top = TRUE, order = TRUE, env = "CA_rPCA1", nrow = 5)
cor_table(cor_df, top = TRUE, order = TRUE, env = "CA_rPCA2", nrow = 5)
cor_table(cor_df, top = TRUE, order = TRUE, env = "CA_rPCA3", nrow = 5)
```
