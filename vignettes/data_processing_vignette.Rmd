...
```{r str impute}
str_dos <- str_impute(gen = dosage, K = 1:3, entropy = TRUE, repetitions = 3, quiet = FALSE, save_output = NULL)
```

Let's take a look at how the two imputation methods compare.
