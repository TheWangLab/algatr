...
This package also allows a user to look at the relationship between distance metrics using the `plot_dist()` function, and to visualize one genetic distance metric with a heatmap using the `gen_dist_hm()` function.
