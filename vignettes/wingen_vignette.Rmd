...
# Note: the CRS argument specifies the coordinate reference system of the input coordinates; in this case, our coordinates are WGS84 longitude and latitude coordinates, so we specify a WGS84 CRS using the EPSG code 4326. Make sure to specify the correct CRS for your coordinates here.
coords_longlat <- st_as_sf(liz_coords, coords = c("x", "y"), crs = 4326)
