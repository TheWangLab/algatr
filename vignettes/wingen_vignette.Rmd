...
devtools::github_install("wingen")
```
...
```{r preview gd, fig.width = 7, fig.height = 7, fig.align='center', warning=FALSE, message=FALSE}
...
```{r plot window, warning=FALSE, fig.width=7, fig.height=7, fig.align='center'}
par(mfrow = c(1, 2), oma = rep(1, 4), mar = rep(2, 4))
# Plot map of pi
...
```{r plot krige, fig.height=7, fig.width=7, fig.align='center', warning=FALSE}
par(mfrow = c(1, 2), oma = rep(1, 4), mar = rep(2, 4))
...
```{r mask sample count, fig.align='center', fig.width=7, fig.height=7, warning=FALSE}
...
```{r wingen do everything, warning=FALSE, results='hide'}
