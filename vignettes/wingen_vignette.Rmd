...
Below, we'll run wingen with the following: TODO FINISH THIS UP

-   Window size of 3x3, no aggregation factor for moving window

-   We want sample count to be plotted

-   Pi as our genetic diversity statistic

-   No rarefaction

-   Kriging (of both genetic diversity and sample count layers) and masking to sample count layer
...
#                      agg_grd = NULL, disagg_grd = 5, agg_r = NULL, disagg_r = NULL, 
#                      masked = TRUE, mask = kgd[["sample_count"]], bkg = envlayer, plot_count = TRUE)
```
