...
euc_dists <- gen_dist_calc(vcf_file = here("TODO.vcf"), dist_type = "euclidean")
...
plink_dists <- gen_dist_calc(plink_file = here("TODO.dist"), plink_id_file = here("TODO.dist.id"), dist_type = "plink")
```

Finally, let's calculate PC-based distances using a significance threshold of 0.01 (the default):

```{r}
pc_dists <- gen_dist_calc(vcf_file = here("TODO.vcf"), dist_type = "pc")
```
