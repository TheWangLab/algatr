...
First, let's get the shape (polygon) for the state of California. This will include the Channel Islands. *TODO[EAC]: We can retrieve administrative boundaries using the `gadm()` function within the geodata package.*
