...
The main function in algatr that runs LFMM is `lfmm_run()`. This function requires that users provide TODO [EAC]: FILL IN. The output from this function is XXX matrices B, U, and V. which correspond to TODO [EAC]: FILL IN ADJUSTED p-VALUES???
...
-   `lfmm_test_result`: TODO [EAC]: FILL IN
...
-   `lfmm_qqplot()`: TODO [EAC]: FILL IN

-   `lfmm_manhattanplot()`: Build a Manhattan plot with defined significance threshold TODO [EAC]: FILL IN
