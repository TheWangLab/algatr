...
For landscape genomic analyses, environmental data layers must be processed in several ways before they can be used as input into methods. This vignette will explore TODO XXX ways to process environmental data:

1. Perform a raster PCA on a stack of environmental layers to reduce dimensionality
2. Detect collinearity between environmental layers
3. Calculate geographic distances between coordinates
