...
**TODO [EAC] add mention here of CRS, warnings, projections, etc. we've implemented checks from wingen but users should always be aware of how this works and ensure that their data match; CRS of coords and raster layer need to match, can't use lat/long for kriging**
