...
# Check for collinearity; the result is a list containing (1) a dataframe of correlated environmental pairs that fall above the threshold and (2) a correlation matrix with all pairwise correlation coefficients
