...
```{r all vars}
gdm_full <- gdm_do_everything(gendist, liz_coords, env = NULL, CA_env, model = "full", alpha = 0.05, scale = TRUE)
```
...
gdm_best <- gdm_do_everything(gendist, liz_coords, env = NULL, CA_env, model = "best", nPerm = 10, scale = TRUE, plot_vars = TRUE)
```
