...
gdm_full <- gdm_do_everything(gendist, liz_coords, CA_env, model = "full", sig = 0.05, scale = TRUE)
```
...
gdm_best <- gdm_do_everything(gendist, liz_coords, CA_env, model = "best", nperm = 100, scale = TRUE, plot_vars = TRUE)
```
